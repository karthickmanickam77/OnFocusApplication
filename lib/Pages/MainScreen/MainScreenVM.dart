...
class MainScreenVM
    extends MainScreenModel with ChangeNotifier{
  ...
  void initialize() {
    ...
    setBottomBarElements([
      ...
      BottomNavElementBO(
        image:
            "lib/Helpers/Images/HomeIcon.png",
        name: "Home",
      ),

      BottomNavElementBO(
        image:
            "lib/Helpers/Images/InsightsIcon.png",
        name: "Insights",
      ),

      BottomNavElementBO(
        image:
            "lib/Helpers/Images/FocusIcon.png",
        name: "Focus Mode",
      ),

      BottomNavElementBO(
        image:
            "lib/Helpers/Images/profile.png",
        name: "Profile",
      ),
    ]);
    notifyListeners();
