...
class InsightsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
          ...
          child: Column(
            ...
            children: [
             ...
             Stack(
               children: [
                 Container(
                  ...
                  padding: EdgeInsets.only(left: ResponsiveUI.w(5, context),top: ResponsiveUI.h(11, context),bottom: ResponsiveUI.h(8, context)),
                  
                   child: Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    crossAxisAlignment: CrossAxisAlignment.start,
                     children: [
                      Text('Focus vs Distraction',style: TextStyle(
                        fontFamily: 'SFPro',
                        fontSize: ResponsiveUI.sp(16, context),
                        fontWeight: FontWeight.bold,
                      ),),
                      SizedBox(height: ResponsiveUI.h(12, context),),
                      (vm.getSelectedFilter() == "This Month")?SizedBox(height: ResponsiveUI.h(12, context)):Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          InsightScreenBarGraphCategory(categoryName: 'Focused Time', categoryColor: Color(0xFF5140F2)),
                          SizedBox(width: ResponsiveUI.w(30, context),),
                          InsightScreenBarGraphCategory(categoryName: 'Distracted Time', categoryColor: Color(0xFFF55757)),
                        ],
                      ),
                      SizedBox(height: ResponsiveUI.h(20, context),),
                       (vm.getSelectedFilter() == "This Month")?Padding(
                         padding:  EdgeInsets.only(left: ResponsiveUI.w(50, context), right: ResponsiveUI.w(34, context)),
                         child: SizedBox(
                           ...
                           children: 
                             List.generate(
                               vm.getGraphList().length, (index) {
                                return ReusableInsightsBarGraph(insightsBarGraphBOData: (vm.getSelectedFilter() == "This Week") ? InsightsBarGraphBO(focusedbarHeight: 100, distractedBarHeight: 51) : InsightsBarGraphBO(focusedbarHeight: 27, distractedBarHeight: 13));
                               }
                             ),
                         ),
                       ),
                       SizedBox(height: ResponsiveUI.h(11, context),),
                       Padding(
                         padding:  EdgeInsets.only(right: ResponsiveUI.w(34, context),left: ResponsiveUI.w(50, context)),
                         child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: List.generate(vm.getGraphList().length, (index){
                            return Text(vm.getGraphList()[index],style: TextStyle(
                              fontFamily: 'SFPro',
                ...
                Transform.translate(
                  offset: Offset(ResponsiveUI.w(8, context), ResponsiveUI.h(70, context)),
                  child: Column(
                    children: List.generate(hoursInBarGraph.length, (index) {
                      return Column(
                        children: [
                          Text(hoursInBarGraph[index],style: TextStyle(
                            fontFamily: 'SFPro',
                            fontSize: ResponsiveUI.sp(10, context),
             ...
             Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: [
                 Text('Top Distracting Apps',style: TextStyle(
             ...
             Column(
              children:List.generate(5, (index){
                return Padding(
                  padding:  EdgeInsets.only(bottom: ResponsiveUI.h(12, context)),
                  child: ReusableProgrssBar(),
                );
              })
             ),
             SizedBox(height: ResponsiveUI.h(4, context),),
             Text('Productive Heatmap',style:TextStyle(
              fontFamily: 'SFRounded',
              fontSize: ResponsiveUI.sp(18, context),
              fontWeight: FontWeight.bold,
             ) ,),
             Padding(
               padding:  EdgeInsets.only(left: ResponsiveUI.w(28, context),bottom: ResponsiveUI.h(11, context),top: ResponsiveUI.h(10, context)),
               child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: List.generate(time.length, (index) => SizedBox(
             ...
             Row(
               children: [
                Column(
      children: 
        List.generate(vm.days.length, (index) => SizedBox(
          height: ResponsiveUI.h(16.5, context),
          child: Center(
            child: Text(vm.days[index],style: TextStyle(
              fontFamily: 'SFProRounded',
              fontSize: ResponsiveUI.sp(12, context),
              fontWeight: FontWeight.w600,
              color: Color(0xff787995),
    ...
    SizedBox(width: ResponsiveUI.w(13, context),),
