...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(
    ...
    final vm = ref.watch(homeScreenProvider);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Container(
            padding:
                EdgeInsets.symmetric(horizontal: ResponsiveUI.w(20, context)),
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ClipRRect(
                    borderRadius:
                        BorderRadius.circular(ResponsiveUI.r(32, context)),
                    child: Stack(clipBehavior: Clip.none, children: [
                      Container(
                        padding: EdgeInsets.symmetric(
                            horizontal: ResponsiveUI.w(19, context),
                            vertical: ResponsiveUI.h(30, context)),
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  ...
                                  top: ResponsiveUI.h(4, context)),
                              child: Text(
                                lang.minutes15, //'for 15 min',
                                style: GoogleFonts.inter(
                ...
                Row(
                  ...
                  children: [
                    QuickStartContainer(
                        colorCode: Color(0xff5041EC),
                        text: lang.startFocus, // 'Start Focus',
                        image: "lib/Helpers/Images/startFocusIcon.png"),
                    QuickStartContainer(
                        colorCode: Color(0xff1CA286),
                        text: lang.takeBreak, // 'Take a Break',
